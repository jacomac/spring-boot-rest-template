...
public class ApiConfig {
    ...
    /**
     * this tags all REST endpoints that are used for retrieving information on
     * drugs
     */
    @Bean
    public GroupedOpenApi drugInfoApi() {
        String paths[] = { "/articles/**" };
        return GroupedOpenApi.builder().group("drug-info").pathsToMatch(paths).build();
    }
